          ...
          <>
            <section className="mb-12 relative overflow-hidden rounded-3xl bg-slate-900 p-8 md:p-12 border border-slate-800 shadow-2xl">
              ...
              <div className="relative z-10 max-w-2xl">
                ...
                <h2 className="text-4xl md:text-6xl font-rajdhani font-bold mb-4 tracking-tight text-slate-100">
                  Premium <span className="text-violet-500 neon-text">Gaming.</span>
                </h2>
                <p className="text-slate-400 text-lg mb-8 leading-relaxed max-w-lg">
                  Access a curated library of HTML5 games, optimized for performance and always unblocked.
                </p>
              ...
              <div className="hidden lg:flex absolute right-12 top-1/2 -translate-y-1/2 flex-col gap-6">
                {[
                  ...
                  { icon: <Trophy className="text-violet-500" />, label: "Daily New Games" },
                ].map((item, idx) => (
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold flex items-center gap-2 text-slate-100">
                  ...
                  {activeCategory === GameCategory.ALL ? 'Top Picks' : `${activeCategory} Games`}
                </h3>
                <span className="text-xs text-slate-500 font-medium">{filteredGames.length} Games Available</span>
              </div>
              ...
              {filteredGames.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-slate-500 border-2 border-dashed border-slate-800 rounded-3xl">
                  ...
                  <p className="text-lg font-medium italic opacity-50">No unblocked games found...</p>
                </div>
              )}
            </section>
          </>
      ...
      {!selectedGame && (
        <footer className="border-t border-slate-900 bg-slate-950 px-4 py-8 mt-auto">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-violet-600 rounded flex items-center justify-center shadow-lg">
            ...
            <p className="text-slate-600 text-xs">
              © 2024 NovaArcade Unblocked Games Hub.
            </p>
          </div>
        </footer>
      )}
