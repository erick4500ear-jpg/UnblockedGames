  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        >
          <div className="p-2 bg-violet-600 rounded-lg group-hover:bg-violet-500 transition-colors neon-border">
        ...
        <div className="flex-1 max-w-xl relative">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-700 rounded-full py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-violet-600/50 transition-all text-sm"
        ...
        <div className="flex items-center gap-3">
          <button className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium hover:text-violet-400 transition-colors">
            Leaderboard
          </button>
